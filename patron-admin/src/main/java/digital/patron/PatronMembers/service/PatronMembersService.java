...
public class PatronMembersService {
    ...
    public void saveBusinessManager(BusinessManager businessManager){
        businessManagerRepository.save(businessManager);
    }

    //LeftMembers
    public List<LeftMember> getAllLeftMembers() {
        return leftMemberRepository.findAll();
    }
